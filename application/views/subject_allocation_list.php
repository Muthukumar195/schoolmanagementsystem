				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Subject Allocation</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('subject_allocation/validate_subject_allocation_details', array('subject'=>'form-horizontal')); ?>
                             <strong class="text-danger"><?php echo validation_errors(); ?></strong>
								<fieldset class="content-group">
                                    <div class="form-group">
										<label>Employee code<span class="req">*</span></label>
										 <?php
                                         $option_emp[''] = "Select Employee Code"; 
                                        foreach($employee_list->result() as $emp){
                                            
                                            $option_emp[$emp->Employee_id] = $emp->Employee_code;
                                        }
                                        echo form_dropdown('employee_id', $option_emp, '', 'class="form-control" id="employee_id"');
                                        ?>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('academic_id', $option_aca, '', 'class="form-control" id="academic_id"');
                                        ?>
                                        <div class="text-right">
                                    ...
                                    <div class="form-group">
										<label>Subject code<span class="req">*</span></label>
										 <?php
                                         $option_sub[''] = "Select Subject code"; 
                                        foreach($subject_list->result() as $sub){
                                            
                                            $option_sub[$sub->Subject_id] = $sub->Subject_code;
                                        }
                                        echo form_dropdown('subject_id', $option_sub, '', 'class="form-control" id="subject_id"');
                                        ?>
									</div>
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($subject_allocation_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
														...
														<?php 
                                                        if($row->Subject_allocation_status=="A"){
                                                            echo '<a href="deny?id='.$row->Subject_allocation_id.'" class="text-danger"><i class="icon-cross3"></i>Deny</a>';
                                                        }
                                                        else{
                                                            echo '<a href="approve?id='.$row->Subject_allocation_id.'" class="text-success"><i class="icon-checkmark2"></i>Active</a>';
                                                        }
                                                        ?>
                                                        </li>
