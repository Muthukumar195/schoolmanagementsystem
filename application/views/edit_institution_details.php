			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-pencil6"></i>&nbsp;<strong>Edit Institution Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('institution/edit_validate_institution_details', array('class'=>'form-horizontal')); ?>
                             <span style="color:red; "><?php echo validation_errors(); ?></span> 
								<fieldset class="content-group">
                               	<?php foreach($get_institution_details->result() as $row){ ?>
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											$data1 = array(
												'name'        => 'ins_code',
												'id'          => 'ins_code',
												'value'       => $row->Instution_code,
												'class'       => 'form-control text-capitalize text-semibold',
												'placeholder' => 'Enter Institution Code',											
											);
											echo form_input($data1);
											?>
                                            <input type="hidden" name="id" value="<?php echo $row->Instution_id; ?>">
                                 ...
                                 <div class="text-center">
                                            ...
                                            <input type="reset" class="btn btn-default" value="Cancel" onClick="javascript: document.location.href='institution_details_list'" >
									</div>
                    	<?php }//for loop close ?>
                          </form>  
						</div>
