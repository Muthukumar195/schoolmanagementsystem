				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Student Category</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('student_category/validate_student_category_details', array('class'=>'form-horizontal')); ?>
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($student_category_details_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="edit_student_category_details?id=<?php echo $row->Student_cat_id; ?>" class="text-info"><i class="icon-pen6"></i> Edit</a></li>
