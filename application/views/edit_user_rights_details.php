			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Edit User Rights</h4>
						</div>
				...
				<div class="content">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-pencil6"></i>&nbsp;<strong>Edit User Rights Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('user_rights_details/validate_edit_user_rights_details', array('class'=>'form-horizontal'));
		 					  foreach ($user_rights_details_data->result() as $row)
                              { 
							  ?>
								...
								<fieldset class="content-group">
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											?>
                                            <input type="hidden" name="id" value="<?php echo $row->User_rights_id; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-10">
										  <div class="input-group">
											...
											echo form_dropdown('user_rights[]', $option, $num, $class);
											?>
                                            </div>
