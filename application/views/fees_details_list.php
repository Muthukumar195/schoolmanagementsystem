				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Fees Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('fees_details/validate_fees_details', array('subject'=>'form-horizontal')); ?>
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($fees_details_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
