				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Subject Details</h4>
						</div>
				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Subject</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('subject_details/validate_subject_details', array('subject'=>'form-horizontal')); ?>
					...
					<!--End form-->
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($subject_details_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
...
include("validation/validation_subject_details.php");
