				...
				<div class="content">
                  <div class="row">
						...
						<div class="panel-heading">
							<h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Academic Details</strong></h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                               <?php if($this->session->flashdata('failear_msg')){?>
                                ...
                                <?php } ?>
							 <?php echo form_open_multipart('academic/validate_academic_details', array('class'=>'form-horizontal')); ?>
                             <span style="color:red; "><?php echo validation_errors(); ?></span> 
								<fieldset class="content-group">
                                    ...
                                    <div class="form-group">
										...
										echo form_dropdown('class_name', $option, '', 'class="form-control" id="class_name"');
										?>
										</div>
									</div>
									<div class="form-group">
                        ...
                        <div class="col-md-6">
                           ...
                           <!-- <div class="panel-body">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <?php 
                                $sno=1;
                                foreach($academic_details_list->result() as $row){ ?>
                                    <tr>
                                        <td><?php echo $sno; ?></td>
                                            ...
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="edit_academic_details?id=<?php echo $row->Academic_id; ?>" class="text-info"><i class="icon-pen6"></i> Edit</a></li>
