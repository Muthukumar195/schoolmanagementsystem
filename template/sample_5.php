...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/default/wizard_stepy.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 03 Aug 2016 08:44:05 GMT -->
...
<head>
	...
	<!-- Core JS files --><script type="text/javascript" src="assets/js/plugins/loaders/pace.min.js"></script>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="wizard_stepy.html">Stepy wizard</a></li>
									</ul>
								</li>
								<li>
				     ...
				     <div class="col-sm-12">
					  <div class="panel panel-default">
					   <div class="panel-heading">
					     <h4 class="header"> Fee Collection </h4>
					   </div>
					    <div class>
					  </div> 
					 </div>
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="stepy-basic" action="#">
							<fieldset title="1">
								<legend class="text-semibold">Official Details</legend>
									...
									<div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control pickadate-accessibility" placeholder="Joining date">
										    </div>
										</div>
									</div>  
                                     ...
                                     <div class="col-md-6"> 
                                        <div class="form-group">
											...
											<select placeholder="Course name" class="select form-control">
								...
								<div class="row">
                                    ...
                                    <div class="col-md-6">
										...
										<input type="file" id="student_photo" class="form-control">						
									     </div>
                                    </div>
								</div>
							</fieldset>
							...
							<fieldset title="2">
								<legend class="text-semibold">Personal Detais</legend>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
									     ...
									     <div class="form-group">
											...
											<div class="input-group">
											<span class="input-group-addon"><i class="icon-calendar22"></i></span>
											<input type="text" class="form-control pickadate-accessibility" placeholder="Date of birth">
										    </div>
										</div>    
									</div>
                                  </div>
                              ...
                              <div class="row">
									<div class="col-md-6">
										<div class="form-group">
			                                ...
			                                <input type="text" placeholder="Birth place" class="form-control">
		                                </div>
									</div>
                                ...
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group">
			                                ...
			                                <input type="text" placeholder="Mother tongue" class="form-control">
		                                </div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
			                                ...
			                                <textarea placeholder="Present Address" class="form-control"></textarea>
		                                </div>
                                    </div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Permanent Address:</label>
			                                <textarea placeholder="Permanent Address" class="form-control"></textarea>
		                                </div>
									</div>
                                  </div>   
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
		                                <div class="form-group">
											<label>Pin:</label>
		                                    <input type="number" placeholder="Pin" class="form-control">
		                                </div>
									</div>
								  </div>
                                  <div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="number" placeholder="Father's mobile" class="form-control">
	                                    </div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Father's job" class="form-control">
	                                    </div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Father's Education:</label>
		                                    <input type="text" placeholder="Father's education" class="form-control">
	                                    </div>
									</div>
								</div>
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Father's income" class="form-control">
	                                    </div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
                                ...
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="number" placeholder="Mother's mobile" class="form-control">
	                                    </div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
										    <label>Mother's Job:</label>
		                                    <input type="text" placeholder="Mother's job" class="form-control">
	                                    </div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Mother's education" class="form-control">
	                                    </div>
									</div><div class="col-md-6">
										<div class="form-group">
										    <label>Mother's Income:</label>
		                                    <input type="text" placeholder="Mother's income" class="form-control">
	                                    </div>
									</div>
								</div>
							</fieldset>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Guardian's name" class="form-control">
	                                    </div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Guardian's Relation:</label>
		                                    <input type="text" placeholder="Guardian's relation" class="form-control">
	                                    </div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Guardian's job" class="form-control">
	                                    </div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Guardian's Education:</label>
		                                    <input type="text" placeholder="Guardian's education" class="form-control">
	                                    </div>
									</div>
								</div>
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group">
		                                    ...
		                                    <input type="text" placeholder="Guardian's income" class="form-control">
	                                    </div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
										    <label>Guardian's Address:</label>
		                                    <textarea placeholder="Guardian's address" class="form-control"></textarea>
	                                    </div>
									</div>
                                </div>
...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/default/wizard_stepy.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 03 Aug 2016 08:44:06 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8"><!-- /Added by HTTrack -->
</html>
