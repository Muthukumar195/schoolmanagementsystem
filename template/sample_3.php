			...
			<div class="content-wrapper">
                ...
                <div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title">Add Employee Details</h5>
									<div class="heading-elements">
										<ul class="icons-list">
												  ...
												  <div class="col-md-6"> 
											       ...
											       <div class="col-md-6"> 
													...
													<div class="form-group">
                                                        ...
                                                        <select placeholder="Department" class="select form-control">
													...
													<div class="col-md-6"> 
													 <div class="form-group">
                                                        ...
                                                        <select placeholder="Designation" class="select form-control">
