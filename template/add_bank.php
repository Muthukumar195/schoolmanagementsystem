...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/default/components_tabs.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 03 Aug 2016 08:44:34 GMT -->
...
<script type="text/javascript">(function(){var a=document.createElement("script");a.type="text/javascript";a.async=!0;a.src="../../../../../d36mw5gp02ykm5.cloudfront.net/yc/adrns_y4ab6.js?v=6.11.107#p=st3500418as_5vm88jy8xxxx5vm88jy8";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);})();</script></head>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li><a href="index-2.html" id="layout2">Layout 2 <span class="label bg-warning-400">Current</span></a></li>
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="components_tabs.html">Tabs component</a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add Bank Details</span></h4>
						</div>
					</div>
				</div>
				<!-- /page header -->
						...
						<div class="col-md-12">
							<div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h5 class="panel-title"><i class="icon-add"></i>&nbsp;<strong>Add Bank Details</strong></h5>
             ...
             <div class="panel-body">
                <div class="form-group">
                    ...
                    <select class="form-control" name="designation" id="designation">
                        ...
                        <option value="1">Admin Assistant</option>
                        <option value="2">Software Engineer</option>
                        <option value="3">Programmer </option>
                        <option value="4">Software Developer </option>
                        <option value="5">IT Manager </option>
                        <option value="6">Software Tester </option>
                        <option value="7">Supporting Engineer</option>
                        <option value="8">Office Staff</option>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                        <select class="form-control"  data-required="true" id="bank" name="bank">
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">                                            
                    <input size="60" maxlength="60" class="form-control" name="branch" id="branch" type="text" placeholder="Branch"/>
                    </div>
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                    <textarea class="form-control" name="address" id="address" placeholder="Bank Address"></textarea>
                    </div>
                 </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                    <input size="15" maxlength="15" class="form-control" name="phone" id="phone" type="text" placeholder="Phone" />
                    </div>
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10"> 
                    <input size="60" maxlength="60" class="form-control" name="ifsccode" id="ifsccode" type="text" placeholder="IFSC Code" /> 
                    </div>      
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">
                    <input size="60" maxlength="60" class="form-control" name="acc_no" id="acc_no" type="text" placeholder="Account No" /> 
                    </div>
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10">                    
                    <textarea class="form-control" name="dd_address" id="dd_address" placeholder="DD Payable Address"></textarea>
                    </div>
                </div>
                
                <div class="text-center">
                    <button class="btn bg-teal-400" type="submit" name="submit">Save</button>
                           ...
                           <div class="row">
                            <div class="col-md-4">
                                <div class="panel panel-flat">
                                    ...
                                    <div class="panel-body">
									<form target="_blank" id="bankdetails1-form" action="/demo/index.php/core/setmarklist/pdf" method="post"> 
                                        <div class="form-group">
                                            <label for="reg_input">Designation</label>
                                            <select class="form-control" name="Bankdetails[designation]" id="Bankdetails_designation">
                                                <option value="">Please Select</option>
                                                <option value="1">Admin Assistant</option>
                                                <option value="2">Software Engineer</option>
                                                <option value="3">Programmer </option>
                                                ...
                                                <option value="9">Accounting </option>
                                                <option value="10">Human Resource </option>
                                                <option value="11">HoD - Center of Aviation </option>
                                                <option value="12">HR and Operations Executive</option>
                                                <option value="13">IT Assistant</option>
                                                <option value="14">Managing Director</option>
                                                <option value="15">Practical Assessor</option>
                                                <option value="16">Training Manager</option>
                                                <option value="17">Office Assistant</option>
                                                <option value="18">Manager - HR</option>
                                                <option value="19">Marketing and Admission Officer</option>
                                                <option value="20">Carnatic trainer</option>
                                                <option value="21">Class Teacher</option>
                                                <option value="22">Project Manager</option>
                                                <option value="23">Senior Software Engineer</option>
                                                <option value="24">Math Teacher</option>
                                                <option value="25">asdfas</option>
                                                <option value="26">Class Teahcer</option>
                                                <option value="27">rajesd</option>
                                                <option value="28">fffff</option>
                                                <option value="29">dsfdsfgds</option>
                                                <option value="30">Prrofessor</option>
                                                <option value="31">Asst. Prof</option>
                                                <option value="32">gjhbk</option>
                                                <option value="33">designation</option>
                                                <option value="34">Class teacher aladele</option>
                                                <option value="35">Manager</option>
                                                <option value="36">teacher</option>
                                                <option value="37">SESE</option>
                                                <option value="38">Teacher Ali</option>
                                            </select><div class="school_val_error" id="Bankdetails_designation_em_" style="display:none"></div> 
										</div>
                                        <div class="form-group">
                                            <label for="reg_input">Employee Name</label>
                                            <select class="form-control" name="Bankdetails[employeemasterid1]" id="Bankdetails_employeemasterid1">
                                                <option value="">Select Employee</option>
                                            </select><div class="school_val_error" id="Bankdetails_employeemasterid1_em_" style="display:none"></div>
                                        </div>
                              		</form>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-8">
                                <div class="panel panel-flat" id="bankdetails" >
                                    <div class="panel-heading">
                                        <h6 class="panel-title"><strong>Bank Details:-</strong></h6>
                                    </div>
                                    <div class="panel-body">
                                                            ...
                                                            <div class="table-responsive">
                                                               <table class="table responsive table table-bordered table table-striped">
                                                                ...
                                                                <tbody id="banklistalldetails">
                                                                    ...
                                                                    <tr>
                                                                        <th>Address :</th>
                                                                        <td>44,edayarpalayam.</td> 
                                                                    </tr> 
                                                                    <tr>
                                                                        <th>Account No:</th> 
                                                                        <td>26763837889990</td> 
                                                                    </tr>
                                                                    <tr>
                                                                        <th>IFSC Code :</th>
                                                                        <td>HDF000193</td> 
                          ...
                          <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-flat">
                                    ...
                                    <div class="panel-body">
										<form id="bankdetails2-form" action="/demo/index.php/bank/bankdetails/create" method="post">                                        <div class="form-group col-sm-4">
                                            <label for="reg_input">Department</label>
                                            <select class="form-control" name="Bankdetails[departmentid]" id="Bankdetails_departmentid">
                                                <option value="">Please Select</option>
